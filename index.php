		...
		<div id="outer">
			...
			<div id="main">
				...
				<h3>Anketa</h3>
					...
					<div class="form">
					<form action="files/glasanje.php" method="post" id="poll">
						<p>
						...
						<p>
							<span><a href="#">Vidjeti rezultate</a></span> 
							<input type="Submit" name="Submit" value="Vote" class="inputButton" />
						</p>
                </form>					
					</div>
				...
				<div id="sidebar2">
					...
					<div style="border: 1px solid black; height: 200px;padding: 2px; border-radius: 5px; ">
					<h4>Top savjet</h4>
                      <?php
                        include ('php/savjet.php');
                        ?>
					</div>
					<ul class="linkedList">
						<li class="first">
				...
				<div id="content">
					<div id="box1">
						...
						<div class="blogpost">
							<h2>Autorex d.o.o</h2>
							<img class="left" src="img/slide6.jpg" width="290" height="200" alt="" />
							<p>
							Preko 15 godina bavimo se automobilima. Sarađujemo sa vodećim svjetskim proizvođačima automobila, autdodijelovlova, opreme, alata... 
							Posjedujemo skladište sa preko 100 hiljada raznih djelova za sve tipove automobila.<br /> Naš tim se sastoji od 25 stručnih lica u oblasti autoindustrije.        
							
		
						  <ul type="circle">
							<b>Mi imamo:</b>
									<li>Autoservis </li>								
									<li>Skladište djelova </li>
									<li>Autodijagnostiku </li>
									<li> </li>
								</ul>
							</p>
							<p class="meta">
